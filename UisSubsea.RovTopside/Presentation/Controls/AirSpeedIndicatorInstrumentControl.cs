...
namespace UisSubsea.RovTopside.Presentation.Controls
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(UisSubsea.RovTopside.Properties.Resources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(UisSubsea.RovTopside.Properties.Resources.AirSpeedNeedle);
