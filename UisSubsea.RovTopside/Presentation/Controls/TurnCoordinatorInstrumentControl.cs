...
namespace UisSubsea.RovTopside.Presentation.Controls

{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(UisSubsea.RovTopside.Properties.Resources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(UisSubsea.RovTopside.Properties.Resources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(UisSubsea.RovTopside.Properties.Resources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(UisSubsea.RovTopside.Properties.Resources.TurnCoordinatorMarks);
