...
namespace UisSubsea.RovTopside.Presentation.Controls
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(UisSubsea.RovTopside.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(UisSubsea.RovTopside.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(UisSubsea.RovTopside.Properties.Resources.Maquette_Avion);
